      ...
      getAQFXMenuOrder().then(data => {
        this.nameList = data.map((item, index) => {
          if (
            ...
            item.vueUrl === "haiyangyuye"
          ) {
            return () =>
              import(
                "./modules/qixiangzaihaizhongdianfangyudanwei/qixiangzaihaizhongdianfangyudanwei.vue"
              );
          } else {
            if (item.vueUrl === "无") {
              return null;
      ...
      switch (this.userInfo.districtName) {
        case "温州市":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-wenzhou.vue");
          break;
        case "永嘉县":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-yongjia.vue");
          break;
        case "瑞安市":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-ruian.vue");
          break;
        case "泰顺县":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-taishun.vue");
          break;
        case "文成县":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-wencheng.vue");
          break;
        case "乐清市":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-leqing.vue");
          break;
        case "龙湾区":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-longwan.vue");
          break;
        case "龙港市":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-longgang.vue");
          break;
        case "洞头区":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-dongtou.vue");
          break;
        case "平阳县":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-pingyang.vue");
          break;
        case "鹿城区":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-lucheng.vue");
          break;
        case "瓯海区":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-ouhai.vue");
          break;
        case "苍南县":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-cangnan.vue");
          break;
        case "经开区":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-jingkai.vue");
          break;
        case "瓯江口":
          this.currentComponent = () =>
            import("./modules/state-map/state-map-oujiang.vue");
          break;
        default:
          this.currentComponent = () =>
            import("./modules/state-map/state-map-wenzhou.vue");
