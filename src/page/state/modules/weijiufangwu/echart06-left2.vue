...
// import { getCityFire } from 'api/state/CityFire'
import $ from 'jquery'
  ...
  .ecahts06 {
    * {
    ...
    .maquee_div2 span {
      ...
      float: left;
      background: -webkit-linear-gradient(left, #a1e0a4, #007be4);
      background: -o-linear-gradient(left, #a1e0a4, #007be4);
      background: -mos-linear-gradient(left, #a1e0a4, #007be4);
      background: linear-gradient(left, #a1e0a4, #007be4);
    }
    .li-rymodal {
      /*float: left;
      list-style: none;
