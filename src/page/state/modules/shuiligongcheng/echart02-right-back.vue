  ...
  <div class="wrapper">
    <div class="wrapper-item monitor">
      ...
      <div class="item-content">
        <ul class="waterList">
          <li>
            <div @click="toMonitorJump('shuiqingjiance',0)">河道</div>
            <div @click="toMonitorJump('shuiqingjiance',0)">总数 {{data.riverMonitorTotal || 0}} 个</div>
            <div @click="toMonitorJump('shuiqingjiance',0)">报警 <span>{{data.riverMonitorWarn || 0}} 个</span></div>
          </li>
          <li>
            <div @click="toMonitorJump('shuiqingjiance',1)">水库<b v-show="userInfo.districtName==='温州市'">(大中型)</b></div>
            <div @click="toMonitorJump('shuiqingjiance',1)">总数 {{data.reservoirMonitorTotal || 0}} 个</div>
            <div @click="toMonitorJump('shuiqingjiance',1)">超汛限 <span>{{data.reservoirMonitorWarn || 0}} 个</span></div>
          </li>
        </ul>
      </div>
    </div>
...
import { getWaterProject, getWaterProjectMainByUserOH, getWaterProjectMainByUserLG } from "@/api/state/WaterProject";
