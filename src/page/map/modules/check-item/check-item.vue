...
export default {
  ...
  methods: {
    ...
    move(direction) {
      ...
      const firstWidth = parseInt(window.getComputedStyle(this.$refs.item[1]).width)
      const count = parseInt(parseInt(window.getComputedStyle(contentEl).width) / firstWidth)
      if (direction === 'prev') {
