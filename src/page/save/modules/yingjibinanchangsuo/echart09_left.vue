  ...
  .wrapper {
    ...
    .echart {
      ...
      .maquee_div2 span {
        ...
        margin-top: 0.01rem;
        float: left;
        background: -webkit-linear-gradient(left, #1A689D, #0EC8E5);
        background: -o-linear-gradient(left, #1A689D, #0EC8E5);
        background: -mos-linear-gradient(left, #1A689D, #0EC8E5);
        background: linear-gradient(left, #1A689D, #0EC8E5);
      }
      .li-rymodal {
        /*float: left;
      list-style: none;
