  ...
  <div>
    ...
    <div class="modal" v-show="dialogVisible">
      <header>
        ...
        <i
          @click="(dialogVisible = false), selectImgMarker.remove()"
      ...
      <section>
        <iframe
          ...
          :src="`http://10.36.226.3:8089/video/index.html?url=${videoUrl}`"
        ></iframe>
      </section>
    </div>
...
export default {
  ...
  watch: {
        ...
        if (this.userDistrict == "330328") {
          getWcxRainMonitorPoint(data[0], data[1], 0).then((res) => {
            ...
            for (var i = 0; i < features.features.length; i++) {
              features.features[i].properties.stationYl =
                features.features[i].properties.station +
                ":" +
                features.features[i].properties.yl;
            }
            ...
            if (!__this.map.getSource("shuiliyuqingjiance" + "_source")) {
              ...
              __this.map
                .getSource("shuiliyuqingjiance" + "_source")
                .setData(features);
            }
            // 设置图层
        ...
        if (this.userDistrict == "330328") {
          getWcxRainMonitorPoint(data[0], data[1], 1).then((res) => {
            ...
            if (!__this.map.getSource("qixiangyuqingjiance" + "_source")) {
              ...
              __this.map
                .getSource("qixiangyuqingjiance" + "_source")
                .setData(features);
            }
            // 设置图层
        ...
        if (!data.allData) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].checked === true) {
              ...
              if (
                data[i].alias === "liangkeyiweijiance_hc" ||
                data[i].alias === "liangkeyiweijiance_kc"
              ) {
                var tablename = data[i].datasetname.substring(
                  data[i].datasetname.indexOf(":") + 1
                );
                this.getLiangkeyiweijianceData(
                  data[i].sql,
                  tablename,
                  data[i].alias,
                  data[i].name,
            ...
            // 取消
              ...
              if (
                data[i].alias === "shuikushuiqingjiance" ||
                data[i].alias === "hedaoshuiqingjiance" ||
                data[i].alias === "dongtoushuikushuiqingjiance" ||
                data[i].alias === "dongtouhedaoshuiqingjiance" ||
              ...
              for (var i = 0; i < data.length; i++) {
                ...
                if (data[i].checked === true) {
                  ...
                  if (
                    ...
                    __this.getLiangkeyiweijianceData(
                      data[i].sql,
                      tablename,
                      data[i].alias,
                      data[i].name,
                    ...
                    // 添加散点图
                    __this.addScatterLayerFromServer(
                      data[i].url,
                      data[i].alias,
                      data[i].icon,
                      data[i].datasetname,
        ...
        if (data.name === "地灾监测") {
          ...
          if (data.checked === true) {
            ...
            if (data.alias === "yuchuanjiance") {
              var tablename = data.datasetname.substring(
                data.datasetname.indexOf(":") + 1
              );
              this.getYuchuanjianceData(
                data.sql,
                tablename,
                data.alias,
                data.name,
              ...
              (data.alias === "shuiliyuqingjiance" ||
                data.alias === "qixiangyuqingjiance") &&
              this.userDistrict == "330328"
            ) {
              var type = 0;
              ...
              this.getWcxYuqingjiancejianceData(
                "",
                "",
                type,
                data.alias,
              ...
              this.getShuiliYuqingjiancejianceData(
                data.alias,
                data.name,
                data.icon
              );
          ...
          // 取消
            ...
            if (
              data.alias === "shuikushuiqingjiance" ||
              data.alias === "hedaoshuiqingjiance" ||
              data.alias === "dongtoushuikushuiqingjiance" ||
              data.alias === "dongtouhedaoshuiqingjiance" ||
              // || data.alias === 'yongjiashuikushuiqingjiance' || data.alias === 'yongjiahedaoshuiqingjiance'
              data.alias === "liangkeyiweijiance_hc" ||
              data.alias === "liangkeyiweijiance_kc"
            ) {
          ...
          if (__this.isMapLoaded) {
            ...
            if (data.checked === true) {
              ...
              if (data.alias === "yuchuanjiance") {
                ...
                __this.getWcxYuqingjiancejianceData(
                  "",
                  "",
                  type,
                  data.alias,
                ...
                __this.getShuiliYuqingjiancejianceData(
                  data.alias,
                  data.name,
                  data.icon
                );
    ...
    specalPointGuanJianSheBei(data) {
      ...
      var centerAry = [];
      if (
        this.specalPointGuanJianSheBei.lon ||
        this.specalPointGuanJianSheBei.longitude
      ) {
        ...
        if (data.daxingguanjianshebeiType === "单兵设备") {
          ...
          this.selectImgMarker = new mapboxgl.Marker(selectEl)
            .setLngLat(centerAry)
            .addTo(this.map);
        }
      }
  ...
  data() {
    return {
      ...
      danbing_point1: {
        ...
        lat: 28.0084796,
        url:
          "rtmp://10.37.253.38:1935/domain=31000000002000000000&resource=31000000001320000012-0&quality=2&src=0",
      },
      danbing_point2: {
        name: "单兵设备(2400)",
        lon: 120.68417422,
        lat: 28.0083784,
        url:
          "rtmp://10.37.253.38:1935/domain=31000000002000000000&resource=31000000001320000071-0&quality=2&src=0",
      },
      startFlag: false,
      currentLayersAlias: [],
      qixiangxinxiAry: [],
  ...
  mounted() {
    ...
    window.shuizhaTab = (type) => {
      let num = Number(type);
      console.log(
        document.querySelectorAll("#map .pop-tip-jianceyujing .types div")[num]
      );
      document
        .querySelectorAll("#map .pop-tip-jianceyujing .types div")
        .forEach((val, index) => {
    ...
    window.toline = function (item) {
      ...
      const rdata = {
        ...
        Data: {
          Uid: Number(item),
          StartTime: pre_timestamp.toString(),
    ...
    if (this.userDistrict != "3303") {
      ...
      if ("瑞安市" === this.districtName) {
        ...
        "瓯海区" === this.districtName ||
        "洞头区" === this.districtName ||
        "文成县" === this.districtName
      ) {
    ...
    this.$bus.on("valueDelete", (val) => {
      ...
      if (val === 1) {
        ...
        if (this.weatherIndex !== val) {
          ...
          if (this.map.getLayer("weather3")) this.map.removeLayer("weather3");
          if (this.map.getLayer("weather6")) this.map.removeLayer("weather6");
          if (this.map.getSource("map_style3"))
            this.map.removeSource("map_style3");
          if (this.map.getSource("map_style6"))
            this.map.removeSource("map_style6");
          ...
          //显示图例
          this.legendAry2 = [];
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/purple.png",
            des: "≥ 50",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/pink.png",
            des: "40 ~ 50",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/blue.png",
            des: "30 ~ 40",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/light-blue.png",
            des: "20 ~ 30",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/green.png",
            des: "10 ~ 20",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/light-green.png",
            des: "0.1 ~ 10",
          });
          this.legendAry2.push({
            icon: "./static/gitimage/jianceyujing/white.png",
            des: "≤ 0.1",
          });
        ...
        //取消勾选
          ...
          this.weatherIndex = -1;
          if (this.map.getLayer("weather1")) this.map.removeLayer("weather1");
          if (this.map.getSource("map_style1"))
            this.map.removeSource("map_style1");
          //隐藏图例
          this.legendAry2 = [];
          this.legendMsg2 = { legendAry: this.legendAry2 };
        }
    ...
    this.$bus.on("valueDeleteRain", (val) => {
      ...
      if (val.checked) {
        ...
        this.legendAry2.push({
          icon: "./static/gitimage/add/purple.png",
          des: "70",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/pink.png",
          des: "50",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/blue.png",
          des: "20",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/light-blue.png",
          des: "10",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/green.png",
          des: "3",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/light-green.png",
          des: "1",
        });
        this.legendAry2.push({
          icon: "./static/gitimage/add/white.png",
          des: "0",
        });
        this.legendMsg2 = { legendAry: this.legendAry2 };
      } else {
    ...
    this.$bus.on("addTyphoonLegend", (val) => {
      ...
      if (!val) {
        ...
        this.legendAry3.push({
          icon: "./static/gitimage/add/rddy.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/rdfb.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/qrdfb.png",
          des: "",
        });
        this.legendAry3.push({ icon: "./static/gitimage/add/tf.png", des: "" });
        this.legendAry3.push({
          icon: "./static/gitimage/add/qtf.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/cqtf.png",
          des: "",
        });
        this.legendAry3.push({ icon: "", des: "警戒线" });
        this.legendAry3.push({
          icon: "./static/gitimage/add/24jjx.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/48jjx.png",
          des: "",
        });
        this.legendAry3.push({ icon: "", des: "风圈" });
        this.legendAry3.push({
          icon: "./static/gitimage/add/7jfq.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/10jfq.png",
          des: "",
        });
        this.legendAry3.push({
          icon: "./static/gitimage/add/12jfq.png",
          des: "",
        });
    ...
    this.$bus.$on("cameraOne", (data) => {
      ...
      if (
        ...
        // this.queryCameraBySmid2(data.video_url, data);
        console.log("视频路径",data.videoUrl)
  ...
  methods: {
    ...mapActions("warning", ["SetMapLoaded", "SetDanbingList"]),
    // 拨号
    dial() {
      if (this.socket2) {
        this.socket2.close();
      ...
      switch (name) {
        case "卫星电话":
          if (status) {
            ...
            this.legendAry.push({
              icon: "./static/gitimage/jianceyujing/wxdh-normal.png",
              des: "卫星电话",
            });
            this.legendMsg = { legendAry: this.legendAry };
          } else {
        ...
        default:
          if (status) {
            ...
            if (name === "布控球") {
              this.legendAry.push({
                icon: "./static/gitimage/jianceyujing/bkq-map.png",
                des: name,
              });
            } else if (name === "无人机") {
              this.legendAry.push({
                icon: "./static/gitimage/jianceyujing/wrj-map.png",
                des: name,
              });
            } else {
              this.legendAry.push({
                icon: "./static/gitimage/jianceyujing/she.png",
                des: name,
              });
            }
            this.legendMsg = { legendAry: this.legendAry };
    ...
    open() {
      ...
      const data = {
        Code: 20000,
        Data: { LoginName: "wxzhouddy", Password: "123456" },
      };
    ...
    getInfo() {
      getIndividualData().then((res) => {
        ...
        if (document.getElementsByClassName("pop-tip-title")[0]) {
          this.popName = document.getElementsByClassName(
            "pop-tip-title"
          )[0].innerHTML;
    ...
    addVideoHtmlPopup(data, type) {
      ...
      // } else {
           console.log("视频路径",data.url)
      this.videoUrl = data.url;
      this.title = data.name;
      this.dialUrl = `ws://127.0.0.1:9005/websocket/${Date.parse(
        new Date()
      )}?domainId=${data.phoneInfo.domainID}&deviceId=${
        data.phoneInfo.deviceID
      }&nChn=0&nSrc=0`;
    ...
    addVideoHtml(data, type) {
      ...
      if (type === "布控球") {
        ...
        name = "单兵设备";
        url = require("./images/she.png");
        if (data.online === "-" || data.online === "否")
          url = require("./images/she-close.png");
      }
      el.innerHTML = `<img src = ${url} width="30px" height="30px">`;
      let wsUrl = `ws://127.0.0.1:9005/websocket/${Date.parse(
        new Date()
      )}?domainId=${data.phoneInfo.domainID}&deviceId=${
        data.phoneInfo.deviceID
      }&nChn=0&nSrc=0`;
      ...
      imgMarker
        .getElement()
        .setAttribute("chargePhone", data.chargePhone || "-");
      var __this = this;
      imgMarker.getElement().onclick = (e) => {
        ...
        if (name === "单兵设备") {
          ...
          var selectUrl = require("./images/she-select.png");
          selectEl.innerHTML = `<img src = ${selectUrl} width="30px" height="30px">`;
          __this.selectImgMarker = new mapboxgl.Marker(selectEl)
            .setLngLat([data.lon, data.lat])
            .addTo(__this.map);
        }
      };
    ...
    addWXHtmlPopup(data) {
      ...
      el.innerHTML = `<img src = ${url} width="30px" height="30px">`;
      var html =
        '<div class="pop-tip-jianceyujing yingjiguanjianshebei" style="height: 90%;">' +
        "<h3>" +
        (data.isatphone_tel || "-") +
        "</h3>" +
        '<ul class="wx_ul">' +
        "<li><span>名称:</span><span>" +
        (data.deviceInfo.deviceName || "-") +
        "</span></li>" +
        "<li><span>联系人:</span><span>" +
        (data.deviceInfo.deviceUser || "-") +
        "</span></li>" +
        "<li><span>联系方式:</span><span>" +
        (data.deviceInfo.deviceUserPhone || "-") +
        "</span></li>" +
        "<li><span>经度:</span><span>" +
        Number(data.longitude).toFixed(4) +
        "</span></li>" +
        "<li><span>纬度:</span><span>" +
        Number(data.latitude).toFixed(4) +
        "</span></li>" +
        "<li><span>时间:</span><span>" +
        (data.deviceInfo.createTime || "-") +
        "</span></li>" +
        "</ul>" +
        `<img src = ${lx} width="30px" height="30px" style ="float: right;cursor: pointer;"` +
        "onclick=\"toline('" +
        data.Uid +
        "')\">" +
    ...
    addWXHtml(data) {
      ...
      if (!data.deviceInfo) {
        ...
        var html =
          ...
          '<ul class="wx_ul">' +
          "<li><span>名称:</span><span>" +
          (data.deviceInfo.deviceName ? data.deviceInfo.deviceName : "-") +
          "</span></li>" +
          "<li><span>联系人:</span><span>" +
          (data.deviceInfo.deviceUser ? data.deviceInfo.deviceUser : "-") +
          "</span></li>" +
          "<li><span>联系方式:</span><span>" +
          (data.deviceInfo.deviceUserPhone
            ? data.deviceInfo.deviceUserPhone
          ...
          "</span></li>" +
          "<li><span>时间:</span><span>" +
          (data.deviceInfo.createTime ? data.deviceInfo.createTime : "-") +
          "</span></li>" +
          "</ul>" +
          `<img src = ${lx} width="30px" height="30px" style ="float: right;cursor: pointer;"` +
          "onclick=\"toline('" +
    ...
    createBaseMap() {
      ...
      window.earths = this.map; // 全局变量（优化性能）
      var __this = this;
      ...
      var __this = this;
      this.map.loadImage(
        "./static/gitimage/shishishuju/gaowengaojing.png",
      ...
      this.map.loadImage(
        "./static/gitimage/shishishuju/dafenggaojing.png",
        function (error, image) {
          if (error) {
            console.log("error: " + error);
          }
      ...
      this.map.loadImage(
        "./static/gitimage/shishishuju/leidiangaojing.png",
        function (error, image) {
          if (error) {
            console.log("error: " + error);
          }
      ...
      this.map.loadImage(
        "./static/gitimage/shishishuju/baoyugaojing.png",
        function (error, image) {
          if (error) {
            console.log("error: " + error);
          }
      ...
      this.map.loadImage(
        "./static/gitimage/shishishuju/taifenggaojing.png",
        function (error, image) {
          if (error) {
            console.log("error: " + error);
          }
    ...
    addScatterLayerFromServer(
      ...
      var sqlParam = {};
      if (
        this.userDistrict === "3303" ||
        alias === "shuiliyuqingjiance-wenzhou" ||
        alias === "qixiangyuqingjiance-wenzhou"
      ) {
        ...
        if ("" === sql) {
          ...
          attributeFilterSql =
            "DISTRICT_CODE='" + this.userDistrict + "' AND (" + sql + ")";
        }
        sqlParam = new SuperMap.GetFeaturesBySQLParameters({
          queryParameter: {
            name: alias,
      ...
      new FeatureService(url).getFeaturesBySQL(sqlParam, function (
        ...
        if (serviceResult && serviceResult.result) {
          ...
          if (
            ...
            alias === "hedaoshuiqingjiance" ||
            alias === "dongtoushuikushuiqingjiance" ||
            alias === "dongtouhedaoshuiqingjiance"
            ...
            if (__this.userDistrict == "330381") {
              for (var i = 0; i < features.features.length; i++) {
                if (
                  features.features[i].properties.KSSW !== "" &&
                  features.features[i].properties.CKFLZ !== "" &&
                  features.features[i].properties.KSSW !== null &&
                  features.features[i].properties.CKFLZ !== null &&
                  Number(features.features[i].properties.KSSW) >
                    Number(features.features[i].properties.CKFLZ)
                ) {
              ...
              for (var i = 0; i < features.features.length; i++) {
                if (
                  features.features[i].properties.KSSW !== "" &&
                  features.features[i].properties.XXSW !== "" &&
                  features.features[i].properties.KSSW !== null &&
                  features.features[i].properties.XXSW !== null &&
                  Number(features.features[i].properties.KSSW) >
                    Number(features.features[i].properties.XXSW)
                ) {
                  featureAry2.push(features.features[i]);
                } else {
                  featureAry1.push(features.features[i]);
            ...
            var features1 = {
              type: "FeatureCollection",
              features: featureAry1,
            };
            var features2 = {
              type: "FeatureCollection",
              features: featureAry2,
            };
          ...
          if (
            ...
            if (__this.loadedLayer.indexOf(alias + "_layer") >= 0) {
              ...
              __this.map.on("click", alias + "_layer", function (e) {
                ...
                // 高亮
                var hignlightIcon =
                  icon1.substring(0, 17) + "-light" + icon1.substring(17);
              ...
              __this.map.on("click", alias + "_warn_layer", function (e) {
                ...
                // 高亮
                var hignlightIcon =
                  icon2.substring(0, 17) + "-light" + icon2.substring(17);
                __this.map.loadImage(hignlightIcon, function (error, image) {
                  if (error) {
                    console.log("error: " + error);
                  }
            ...
            if (__this.loadedLayer.indexOf(alias + "_layer") >= 0) {
              ...
              __this.map.on("click", alias + "_layer", function (e) {
                ...
                var hignlightIcon =
                  icon.substring(0, 17) + "-light" + icon.substring(17);
                __this.map.loadImage(hignlightIcon, function (error, image) {
                  if (error) {
                    console.log("error: " + error);
                  }
                ...
                if (alias === "shipinjiance") {
                  var videoUrl = feature.properties.VIDEO_URL;
                  console.log("视频监控",videoUrl);
                  __this.queryCameraBySmid(
                    videoUrl,
                    longitude,
                    latitude,
    ...
    addScatterLayerFromServer2(data) {
          ...
          if (data.info[n].type === name) {
            eachDzzhjcGeoJson.data.features.push({
              ...
              geometry: {
                type: "Point",
                coordinates: [
                  Number(data.info[n].location.split(",")[0]),
                  Number(data.info[n].location.split(",")[1]),
                ],
              },
      ...
      for (var i = 0; i < URL_CONFIG.dizhizaihaijianceAry.length; i++) {
        ...
        this.addDzzhjcLayer(
          URL_CONFIG.dizhizaihaijianceAry[i].name,
          URL_CONFIG.dizhizaihaijianceAry[i].alias,
          URL_CONFIG.dizhizaihaijianceAry[i].icon
        );
      }
    },
    // 添加地质灾害监测散点图
    ...
    queryMonitorBySmid(alias, smid, longitude, latitude, data) {
      ...
      switch (alias) {
        ...
        case "shuiliyuqingjiance-wenzhou":
          getRainMonitorDetailBySmid(smid, "0").then((data) => {
        ...
        case "qixiangyuqingjiance-wenzhou":
          getRainMonitorDetailBySmid(smid, "1").then((data) => {
            __this.addEchartHtml2(
              data.name,
              data.time,
              data.station,
        ...
        case "dongtoushuikushuiqingjiance":
          getDTReservoirMonitorDetailBySmid(smid).then((data) => {
            data.type = "shuiku";
            __this.addEchartHtml(
              data.name,
              data.time,
              data.station,
              longitude,
        ...
        case "dongtoushuizhajiance":
          getDTWaterGateDetailBySmid(smid).then((data) => {
        ...
        case "hedaoshuiqingjiance":
          ...
          getRiverMonitorDetailBySmid(smid).then((data) => {
        ...
        case "shuikushuiqingjiance":
          ...
          getReservoirMonitorDetailBySmid(smid).then((data) => {
            // data = {
            //   'name': '钟前',
            //   'station': '乐清市水利局        ',
        ...
        case "jishuidianjiance":
          getPondingDetailBySmidNew(smid, 0).then((data) => {
            data.type = 0;
            // console.log("data: " + JSON.stringify(data));
        ...
        case "jishuidianjiance_paishui":
          getPondingDetailBySmidNew(smid, 1).then((data) => {
            // console.log("data: " + JSON.stringify(data));
            data.type = 1;
            __this.addEchartHtml(
              data.name,
        ...
        case "liangkeyiweijiance_hc":
          getEnterpriseDetailSmid(smid).then((data) => {
            // console.log("data: " + JSON.stringify(data));
        ...
        case "jingqukeliuliangjiance":
          getScenicDetailBySmid(smid).then((data) => {
    ...
    loadEchartDataShuiku(details, bool, data, xxsw, cklz, legendName) {
      ...
      const myChart = this.$echarts.init(
        document.querySelector("#map .pop-tip-jianceyujing .myechart")
      );
      let options = {
        tooltip: {
          trigger: "axis",
      ...
      if (data) {
        ...
        if (data.max) {
          options.yAxis = {
            ...options.yAxis,
            ...{ max: Math.floor(max + 2), min: Math.floor(min - 2) },
          };
    ...
    addBoatTipHtml(data, longitude, latitude) {
      ...
      var html =
        ...
        "</span></li>" +
        "<li><span>吨位:</span><span>" +
        (data.tonnage || 0) +
        "吨</span></li>" +
        "<li><span>功率:</span><span>" +
        (data.power || 0) +
        "kw</span></li>" +
        "<li><span>渔船属地:</span><span>" +
        (data.cgj || "暂无信息") +
        "</span></li>" +
        "<li><span>作业方式:</span><span>" +
        (data.workmode || "暂无信息") +
        "</span></li>" +
        "<li><span>渔船类型:</span><span>" +
        (data.worktype || "暂无信息") +
        "</span></li>" +
        "<li><span>航向:</span><span>" +
        (data.direction || "暂无信息") +
        "</span></li>" +
        "<li><span>速度:</span><span>" +
        ((data.speed && (data.speed / 10).toFixed(2) + "m/s") || "暂无信息") +
        "</span></li>" +
        "<li><span>上报时间:</span><span>" +
        (data.reportTime || "暂无信息") +
        "</span></li>" +
        "</ul>" +
        "</div>";
      // 删除别的提示框
    ...
    addEnterpriseTipHtml2(data, longitude, latitude) {
      var lngLat = { lng: Number(longitude), lat: Number(latitude) };
      var html =
        '<div class="pop-tip-jianceyujing pop-tip-liangkeyiwei">' +
        "<h3>" +
        data.plate +
        "</h3>" +
        "<ul>" +
    ...
    addScenicTipHtml(data, longitude, latitude) {
      ...
      var html =
        ...
        "</h3>" +
        "<ul>" +
        "<li><span>街道:</span><span>" +
        data.street +
        "</span></li>" +
        "<li><span>当前人数:</span><span>" +
        (data.nowCount ? data.nowCount : 0) +
        "</span></li>" +
        "<li><span>瞬时承载客流量:</span><span>" +
        data.momentCount +
        "</span></li>" +
        "<li><span>当天承载客流量:</span><span>" +
        data.dayCount +
        "</span></li>" +
        "</ul>" +
        "</div>";
    ...
    addEchartHtml(name, time, station, longitude, latitude, type, data) {
      ...
      var html =
        ...
        "</span>" +
        (station !== ""
          ? '<span class="spc">测站所属:' + (station || "暂无信息") + "</span>"
          : '<span class="spc"></span>') +
        "</div>" +
        (this.userInfo.districtName === "永嘉县" &&
        data &&
        data.type === "shuiku"
          ? '<div class="time time-top"><span>当前库容: ' +
            ((data && data.nkr) || "暂无") +
            " (万立方) / 总库容: " +
            ((data && data.zkr) || "暂无") +
            " (万立方)</span></div>"
      ...
      var html =
        ...
        (station !== ""
          ? '<span class="spc">测站所属:' +
            (station || "暂无信息") +
            "</span></div>"
          : '<span class="spc"></span></div>') +
        '<div class="chart">' +
        '<div class="wrapper">' +
        '<div class="tip"><span style="margin-right:0.3rem;margin-top:14%">24小时' +
        (type === "qiwen" ? "温度" : "雨量") +
        "监测</span></div>" +
        '<div class="tip_2">单位(mm)</div>' +
        (this.userInfo.districtName === "文成县" &&
        (type === "qixiang" || type === "qiwen")
          ? '<div class="tip_3">温度</div>'
          : "") +
        '<div class="myechart"></div>' +
        "</div></div></div>";
      // 删除别的提示框
    ...
    loadEchartData2(details, type) {
      ...
      if (
        (this.userInfo.districtName === "文成县" && type === "qixiang") ||
        type === "qiwen"
      ) {
        var datatemperature = [];
        for (var i = 0; i < details.length; i++) {
    ...
    baseMapChangedata(data) {
      ...
      if ("标准底图" === data) {
        console.log("标准底图",data)
        this.checkValue("standard-raster");
      } else if ("大数据底图" === data) {
        console.log("大数据底图",data)
    ...
    measure(e) {
      ...
      if (this.isSpatialQuery === true) {
        ...
        var smidList = "";
        for (var i = 0; i < this.videoAliasAry.length; i++) {
          var eachFeaturesAry = this.map.getSource(
            this.videoAliasAry[i] + "_source"
          )._data.features;
        ...
        var __this = this;
        getVideoTree("", this.videoLevel1Id, false, "", smidList).then(
          (res) => {
        ...
        if ("LineString" === type) {
          ...
          var __this = this;
          new MeasureService(URL_CONFIG.measureurl).measureDistance(
            param,
            (serviceResult) => {
    ...
    mapInit() {
      if (this.userDistrict === "3303") {
        ...
        for (var i = 0; i < getDistrictData.features.length; i++) {
          if (
            this.districtName === getDistrictData.features[i].properties.NAME
          ) {
            districtCenter = getDistrictData.features[i].geometry.coordinates;
            break;
          }
    ...
    loadEchartDataChaowei(data) {
      ...
      const myChart = this.$echarts.init(
        document.querySelector("#map .shishichaowei .myechart")
      );
      let options = {
        tooltip: {
          trigger: "axis",
    ...
    getLiangkeyiweijianceData(sql, tablename, alias, name, icon, type) {
      ...
      getLiangkeyiweiList(sqlText, tablename, type).then((res) => {
        ...
        for (var i = 0; i < features.features.length; i++) {
          if (
            features.features[i].properties.alarm !== "" &&
            features.features[i].properties.alarm.indexOf("1") >= 0
          ) {
            featureAry2.push(features.features[i]);
          } else {
            featureAry1.push(features.features[i]);
    ...
    getYuchuanjianceData(sql, tablename, alias, name, icon) {
      ...
      getYuchuanjianceList(sqlText, tablename).then((res) => {
        ...
        for (var i = 0; i < features.features.length; i++) {
          var trackDirection =
            Number(features.features[i].properties.direction) * 2;
        ...
        if (__this.loadedLayer.indexOf(alias + "_layer") >= 0) {
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance1.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance2.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance3.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance4.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance5.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance6.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance7.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
          ...
          __this.map.loadImage(
            "./static/gitimage/shishishuju/yuchuanjiance8.png",
            function (error, image) {
              if (error) {
                console.log("error: " + error);
              }
    ...
    addorremoveShipinjiankongLayer(val) {
      ...
      if (val.checked) {
        ...
        getVideoPictureInfo(id).then((res) => {
          ...
          var features = res.features;
          console.log("getVideoPictureInfo",res)
          if (!__this.map.getSource(alias + "_source")) {
            __this.map.addSource(alias + "_source", {
              type: "geojson",
              data: features,
          ...
          if (__this.loadedLayer.indexOf(alias + "_layer") >= 0) {
            ...
            __this.map.on("click", alias + "_layer", function (e) {
              ...
              var latitude = e.features[0].geometry.coordinates[1];
              var videoUrl = feature.properties.VIDEO_URL;
               console.log("视频路径feature",feature)
              __this.queryCameraBySmid(
                videoUrl,
                longitude,
                latitude,
