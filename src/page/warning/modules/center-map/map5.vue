        ...
        <div class="image-video-play-icon-range" ref="myRange">
          <div
            ...
            <div
              ...
              v-if="(oneImagePercent >= 4 && (index === 0 || (index !== 1 && index % 3 === 1)))">
...
import { forward } from 'api/warning/warning'
...
export default {
  ...
  data() {
    ...
    return {
      yuntuType: 'http://data.istrongcloud.com/data/images/radar/mingle/caiyun_transparent.json', // 请求地址
  ...
  methods: {
    getYuntuImg() {
      // const data = [
      //   {
      //     'name': '202007061110.PNG',
      //     'url': 'https://upy.istrongcloud.com/radar/mingle/caiyun_transparent/202007/06/202007061110bSzUR872.PNG',
      //     'md5': 'f31aadc75816ca30446596c26073ae66',
      //     'dt': null
      //   }, {
      //     'name': '202007061115.PNG',
      //     'url': 'https://upy.istrongcloud.com/radar/mingle/caiyun_transparent/202007/06/202007061115F1K3AzOf.PNG',
      //     'md5': 'f77c0aed5fc9bacfdbae8e4b3f57955f',
      //     'dt': null
      //   }]
      // this.imgList = data
      forward(this.yuntuType).then((data) => {
