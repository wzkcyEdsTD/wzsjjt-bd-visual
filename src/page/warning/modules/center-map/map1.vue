    ...
    <div class="image-video-play-main">
      ...
      <div class="image-video-play-control">
        ...
        <el-select
          ...
          <el-option label="本地云图" value="http://www.wztf121.com/data/images/cloud/localcloud.json?rand="></el-option>
          <el-option label="中央台FY2" value="http://www.wztf121.com/data/images/cloud/fy2.json?rand="></el-option>
          <el-option label="台湾云图" value="http://www.wztf121.com/data/images/cloud/tw/hs1p.json?rand="></el-option>
          <el-option label="日本云图" value="http://www.wztf121.com/data/images/cloud/jp/japan_wide.json?rand="></el-option>
        </el-select>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      yuntuType: 'http://www.wztf121.com/data/images/cloud/localcloud.json?rand=', // 默认选择本地云图
      imgList: [], // 播放的图片列表
