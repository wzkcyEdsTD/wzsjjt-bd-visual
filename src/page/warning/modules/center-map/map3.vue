    ...
    <div class="image-video-play-main">
      ...
      <div class="image-video-play-control">
        ...
        <el-select
          ...
          <el-option label="1小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour1.json?rand="></el-option>
          <el-option label="3小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour2.json?rand="></el-option>
          <el-option label="6小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour6.json?rand="></el-option>
          <el-option label="12小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour12.json?rand="></el-option>
          <el-option label="24小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour24.json?rand="></el-option>
          <el-option label="48小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour48.json?rand="></el-option>
          <el-option label="72小时雨量分布" value="http://www.wztf121.com/data/images/wz_rain/hour72.json?rand="></el-option>
        </el-select>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      yuntuType: 'http://www.wztf121.com/data/images/wz_rain/hour1.json?rand=', // 默认选择本地云图
      imgList: [], // 播放的图片列表
