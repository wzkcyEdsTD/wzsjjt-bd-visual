...
export default {
  ...
  data() {
    ...
    return {
      yuntuType: 'http://data.istrongcloud.com/data/images/cloud/szmb_transparent.json', // 请求地址
  ...
  methods: {
    getYuntuImg() {
      // const data = [
      //   {
      //     'name': '202007060800.png',
      //     'url': 'https://upy.istrongcloud.com/cloud/szmb_transparent/202007/06/202007060800BmBiBbni.png',
      //     'md5': 'b4ca717aebc3a9d16d97abae51754251',
      //     'dt': null
      //   }, {
      //     'name': ' 202007061300.png',
      //     'url': 'https://upy.istrongcloud.com/cloud/szmb_transparent/202007/06/202007060800BmBiBbni.png',
      //     'md5': 'b4ca717aebc3a9d16d97abae51754251',
      //     'dt': null
      //   }
      ...
      forward(this.yuntuType).then((data) => {
        this.imgList = data
        this.$bus.emit('weixingyuntu', data)
      })
    },
    // 全屏展示
    quanping() {
