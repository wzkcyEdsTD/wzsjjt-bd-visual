<template>
  <div class="wrapper">
    ...
    <div
      class="toCenter"
      :class="{ collapse: collapse1, active: centerShow }"
      title=""
    >
    ...
    <!-- 矢量影像拓展 -->
    <div
      class="toCenter second"
      v-show="centerShow && mapNew[0].isShow && !mapNew[1].isShow"
      :style="{ top: mapNew[0].isShow ? '2.5rem' : '2.9rem' }"
    >
      <div
        class="center-item"
        v-show="item.isShow"
      ...
      >
        <div
          ...
          @click="changeMapChildren(index, index2, item2)"
          :class="{ isChoose: item2.value === currentValue }"
          :key="index2"
        >
    ...
    <div
      class="toCenter2"
      :class="{ collapse: collapse1, active: mapToolsShow }"
      title=""
    >
...
export default {
  ...
  data() {
    return {
      ...
      mapBtn: [{ name: "测距离", value: "line_string", abbrev: "测距" }],
    };
  },
  computed: {
    ...mapGetters("map", ["collapse1"]),
    ...mapGetters(["userInfo"]),
  },
  mounted() {},
  methods: {
    ...
    ...mapActions("warning", ["SetCollapse", "SetClearAllLayers"]),
  },
};
</script>
